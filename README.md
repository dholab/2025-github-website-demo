...
With that, the rest is extremely simple: run `quarto publish gh-pages`, which will create the `gh-pages` branch and plug it into a `.github.io` site, and then paste the following Github into the main branch:
